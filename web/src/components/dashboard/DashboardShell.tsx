...
export function DashboardShell({
  ...
  return (
    <div className="dash-shell flex h-screen flex-col overflow-hidden bg-ground">
      ...
      <header className="dash-topbar z-30 shrink-0 text-white">
        <div className="flex min-h-[3.75rem] flex-wrap items-center gap-2 px-4 sm:gap-3 sm:px-6 lg:px-8">
          ...
          {/* Brand lockup: emblem, then the name over the issuing government,
              matching the reference header. */}
          <Link
            to={homePath}
            className="flex shrink-0 items-center gap-3 rounded-lg text-white"
          >
            ...
            <span className="hidden leading-tight sm:block">
              ...
              <span className="block text-[11px] text-white/70">{t('shell.state')}</span>
            </span>
          </Link>
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <aside
          className={`dash-sidebar fixed bottom-0 left-0 top-[3.5rem] z-50 flex w-[5.5rem] flex-col text-white transition-transform duration-300 lg:static lg:top-0 lg:h-auto lg:translate-x-0 ${
